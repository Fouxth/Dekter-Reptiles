...
/**
 * BankBadge — renders a colored square badge showing the bank abbreviation.
 * Works 100% offline; no external URLs needed.
 * @param {string} bankName — the full bank name as stored in settings (e.g. "กสิกรไทย (K-Bank)")
 * @param {number} size — badge pixel size (default 24)
 */
