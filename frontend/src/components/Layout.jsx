        ...
        <>
            <div className="flex flex-col lg:flex-row h-screen bg-transparent overflow-hidden selection:bg-emerald-500/30">
                ...
                <main className="flex-1 overflow-hidden relative z-10 flex flex-col min-h-0">
                    {/* Desktop Header */}
                    <header className="hidden lg:flex items-center justify-between px-8 py-4 bg-slate-900/40 backdrop-blur-xl border-b border-white/5 shadow-sm relative z-20">
                        <div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            >
                                <Bell size={20} />
                                {unreadCount > 0 && (
                                    <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] bg-emerald-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1 border-2 border-[#0f172a]">
                                        {unreadCount > 9 ? '9+' : unreadCount}
                                    </span>
                                )}
                            </button>
                    ...
                    <div className="flex-1 p-3 sm:p-4 lg:p-6 overflow-auto custom-scrollbar">
                        <Outlet />
                    </div>
